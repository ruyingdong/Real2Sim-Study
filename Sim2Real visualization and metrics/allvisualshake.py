...
def plot_all_views(pcls, labels, metrics, title=""):
    ...
    custom_colors = [
        ...
        (0.0, 0.6, 0.6, 1.0),   # dark cyan
        (0.5, 0.5, 0.0, 1.0),   # dark olive
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t1', '--txt_dir1', type=str, 
                        default='/home/david/Downloads/diffcp-main/src/pinkshakediffcp', 
                        help='First directory containing TXT point clouds')
    parser.add_argument('-t2', '--txt_dir2', type=str, 
                        default='/home/david/Downloads/diffcp-main/src/pinkshakepinn', 
