...
if __name__ == '__main__':
    ...
    with open(out_path+('/log%s.txt'%timestamp),'w',buffering=1) as f:
        ...
        if args.initial_params_file: 
            ...
            initial_stretch = scale(3, low_stretch, high_stretch, inverse=True)
            initial_mass = scale(3, low_mass, high_mass, inverse=True)
        ...
        np.save('default_out_exp22/params.npy', params)
        np.save('default_out_exp22/losses.npy', losses)
