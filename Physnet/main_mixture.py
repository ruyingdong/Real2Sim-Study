...
colors=['#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22',
'#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#d62728','#9467bd','#8c564b','#e377c2']
...
if par.train_mode==2:
    ...
    margin=1
    embedding_net=ResNet18_EmbeddingNet()
...
if par.train_mode==5:
    batch_size=32
    kwargs={'num_workers':4,'pin_memory':True} if cuda else {}
    model=torch.load(model_path+'/wind/model_mixture.pth')
    file_path='./Database'
    data='/'
