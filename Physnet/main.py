...
colors=['#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22',
'#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22',
'#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22',
'#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22',
'#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22','#bcbd22',
'#bcbd22','#bcbd22','#bcbd22','#bcbd22',
'#d62728','#9467bd','#8c564b','#e377c2','#7f7f7f','#232b08','#17becf']
'''
...
if par.train_mode==2:
    ...
    #print("Plotting initial embeddings at epoch 0")
    #train_embeddings_initial, train_labels_initial = extract_embeddings(train_loader, model)
    #plot_embeddings(train_embeddings_initial, train_labels_initial, n_epochs=0)
...
##############################Bayesian_Optimiser###############################
standards=[
    [31.14, -12.8, 44.02, 31.89, 78.7],
    [26.75, 268.68, 27.74, 67.37, 77.77],
    [182.27, -14.66, 113.35, 54.8, 175.12]
]
maxs=np.zeros_like(standards)
mins=np.zeros_like(standards)
for i in range (len(standards)):
    for t in range (len(standards[i])):
        mins[i][t]=standards[i][t]*0.01
        maxs[i][t]=standards[i][t]*100
...
if par.train_mode==5:
    ...
    print(denormalized_bending_stiffness)
