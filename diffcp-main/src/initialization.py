...
lower_bound = dx * (4 - 1)
#lower_bound = 0.31
upper_bound = (1 - dx * (4 - 1))
#upper_bound = 4
print("lower:", lower_bound)
print("upper:", upper_bound)
points = [
    [lower_bound, lower_bound, -0.22],
    [upper_bound, lower_bound, -0.22],
    [lower_bound, upper_bound, -0.22],
    [upper_bound, upper_bound, -0.22],
...
target_pcd.points = o3d.utility.Vector3dVector(target_pcd_array[0])  # 显示第0帧的目标点云
